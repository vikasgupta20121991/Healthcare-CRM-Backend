...
export const getAllUsersForChat = async (req, res) => {
    try {
        ...
        if (getRole.role === "HOSPITAL" && getRole.type === portalType) {
            // console.log("run HOSPITAL")
            getData = await getListforHospitalFourPortal(loggedInId, adminId,req);
        }
