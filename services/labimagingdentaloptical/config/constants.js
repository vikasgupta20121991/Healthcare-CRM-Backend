...
export const config = {
    DB: {
        ...
        DATABASE: process.env.LabImagingDentalOptical_MONGO_DATABASE || "healthcare-crm7",
        USERNAME: process.env.LabImagingDentalOptical_MONGO_USER || "healthcare-crm7",
        PASSWORD: process.env.LabImagingDentalOptical_MONGO_PASSWORD || "CVB345BghS",
    },
    PORTS: {
        API_PORT: process.env.LabImagingDentalOptical_SERVICE_PORT || 8008,
        EMAIL_PORT: 4200,
