...
const front_end_baseurl = process.env.healthcare-crm_FRONTEND_URL
...
export const htmlForgetPassword = (token, user_id) => {
  ...
  <div class="box" style="max-width: 500px; margin: 0 auto; background-color: #F9F9F9;">
   <div class="innerBox" style="max-width: 300px; width: 100%; margin: auto; background-color: #fff; border-radius: 10px; padding: 20px; position: absolute; left: 50%; transform: translateX(-50%);">
      ...
      <a href=${healthcare-crm_FRONTEND_URL}/super-admin/newpassword?token=${token}&user_id=${user_id} style="background-color: #64BD05; text-align: center; display: inline-block; padding: 8px 0px; max-width: 150px; width: 100%; font-size: 14px; font-weight: 300; margin: 15px  auto 0; color: #fff; border-radius: 35px; text-decoration: none;">Click To change Password</a>
      <p style="font-size: 15px; font-weight: 300; color: #656565; text-align: left;margin-top: 25px;">Thanks, healthcare-crm.</p>
   </div>
  </div>
  </body>
...
export const htmlEmailFor2FAOTP = (otp2fa) => {
    return `<!DOCTYPE html>
                  <html lang="en">
                  <head>
                      <meta charset="UTF-8">
                  ...
                  <div class="box" style="max-width: 500px; margin: 0 auto; background-color: #F9F9F9;">
                  <div class="innerBox" style="max-width: 300px; width: 100%; margin: auto; background-color: #fff; border-radius: 10px; padding: 20px; position: absolute; left: 50%; transform: translateX(-50%);">
                      <h1 style="font-size: 32px; color: #272727; font-weight: 600; margin-top: 0; margin-bottom: 0;">Hello User</h1>
                      <p style="font-size: 15px; font-weight: 300; color: #656565; margin-top: 25px;">Your 2FA OTP is: ${otp2fa}</p>
                      <p style="font-size: 15px; font-weight: 300; color: #656565; text-align: left;margin-top: 25px;">Thank You</p>
                  </div>
          </div>
                  </body>
                  </html>
...
export const geterate6DigitOTP = () => {
