...
import roleCounter from "../../models/insurance/role_counter_model";
// utils
import { handleResponse } from "../../helpers/transmission";
import PortalUser from "../../models/insurance/user/portal_user";
import staff_info from "../../models/insurance/user/staff_info";
...
export const all_role = async (req, res) => {
    try {
        ...
        if (checkUser?.role === 'INSURANCE_STAFF') {
            const data = await staff_info.findOne({ staff_createdBy: checkUser?.staff_createdBy });
