...
class PaymentController {
    ...
    async getPaymentHistory_Hospital(req, res) {
        try {
            ...
            const query = [
                ...
                { $unwind: "$portalusersData" },
                {
                    $lookup: {
                        ...
                        as: "hospprofileinfoData",
                    },
                },
                { $unwind: "$hospprofileinfoData" },

                {
                    $project: {
                        ...
                        paymentBy: "$portalusersData.role",
                        Name: { $concat: ["$hospprofileinfoData.first_name", " ", "$hospprofileinfoData.last_name"] }
